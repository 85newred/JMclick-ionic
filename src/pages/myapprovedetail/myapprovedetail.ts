...
@Component({
  selector: 'page-myapprovedetail',
  templateUrl: 'myapprovedetail.html',
})
export class MyapprovedetailPage {
  items: any;
  Leave_Type: any='';
  Leave_Term: any='';
  Start_Date: any='';
  ...
  loadData(){
    ...
    this.storage.get('token').then((val) => {
      ...
      this.http.post('https://jmclicks.com/api/notifications/updateadvanceapproved?token='    + val.token, {TargetId: this.advanceid}).subscribe(result => {
        console.log(result)
      })
