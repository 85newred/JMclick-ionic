...
@Component({
  selector: 'page-jobrejected',
  templateUrl: 'jobrejected.html',
})
export class JobRejectedPage{
  ...
  loaddata(){
    this.storage.get('token').then((val)=>{
      ...
      this.http.get<{badge_count: any, notifications: any}>('https://jmclicks.com/api/notifications/getJob?token=' + val.token,{params:{type:"Job Rejected"}}).subscribe(result => {
        let t = this;
