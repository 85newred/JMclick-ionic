...
import { AssetonhandPage } from '../assetonhand/assetonhand';
...
export class AssetPage {
  ...
  assetonhandpage = AssetonhandPage;
  ...
  loadData(){
    ...
    this.storage.get('token').then((val) => {
      data = this.http.get('https://jmclicks.com/api/assetonhand?token=' + val.token );
    ...
    this.storage.get('token').then((val) => {
      this.http.get<{badge_count: any, notifications: any}>('https://jmclicks.com/api/notifications/getnoticebadge?token=' + val.token).subscribe(result => {
        let that = this
