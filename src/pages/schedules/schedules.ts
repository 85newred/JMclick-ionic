...
export class SchedulesPage {
  ...
  scheduledetailspage = ScheduledetailsPage;
  ...
  loadData(){
    ...
    this.storage.get('token').then((val) => {
      data = this.http.get('https://jmclicks.com/api/getschedules?token=' + val.token );
    ...
    this.storage.get('token').then((val) => {
      this.http.get<{badge_count: any, notifications: any}>('https://jmclicks.com/api/notifications/getScheduleBadge?token=' + val.token).subscribe(result => {
        let that = this
