...
import { AdminpendingadvanceredirectPage } from '../adminpendingadvanceredirect/adminpendingadvanceredirect';
const httpOptions = {
...
@Component({
  selector: 'page-adminpendingdetail',
  templateUrl: 'adminpendingdetail.html',
})
export class AdminpendingdetailPage {

  adminpendingadvanceredirect = AdminpendingadvanceredirectPage;
  ...
  ngOnInit() {
    this.signupform = new FormGroup({
      Total_Approved: new FormControl('', [Validators.required]),
    })
  }
