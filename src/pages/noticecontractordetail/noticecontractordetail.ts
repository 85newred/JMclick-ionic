...
@Component({
  selector: 'page-noticecontractordetail',
  templateUrl: 'noticecontractordetail.html',
})
export class NoticecontractordetailPage {
  ...
  loadData(){
    ...
    this.storage.get('token').then((val) => {
      ...
      this.http.post('https://jmclicks.com/api/notifications/updatecontractornoticebadge?token='    + val.token, {TargetId: this.Id}).subscribe(result => {
        console.log(result)
      })
    });
  }
